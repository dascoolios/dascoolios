...
local function ALRYHW_fake_script() -- visuals.LocalScript 
...
coroutine.wrap(ALRYHW_fake_script)()
local function DGTWHO_fake_script() -- main.LocalScript 
...
coroutine.wrap(DGTWHO_fake_script)()
local function KOXGGQQ_fake_script() -- TextButton.LocalScript 
...
coroutine.wrap(KOXGGQQ_fake_script)()
local function MOPR_fake_script() -- Frame.LocalScript 
...
coroutine.wrap(MOPR_fake_script)()
