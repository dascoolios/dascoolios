...
local function XDVN_fake_script() -- visuals.LocalScript 
...
coroutine.wrap(XDVN_fake_script)()
local function TZUEUHT_fake_script() -- main.LocalScript 
...
coroutine.wrap(TZUEUHT_fake_script)()
local function PMJIOA_fake_script() -- TextButton.LocalScript 
...
coroutine.wrap(PMJIOA_fake_script)()
local function OHOQ_fake_script() -- Frame.LocalScript 
...
coroutine.wrap(OHOQ_fake_script)()
